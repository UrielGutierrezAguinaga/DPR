...
const RegistrarPermiso = () => {
    ...
    return (  
        ...
        <Header>
              <ContenedorHeader>
                  <Titulo>Registro de Permiso</Titulo>
                  </ContenedorHeader>
        </Header>
           
        <BotonAtras ruta="/permiso"/>


        <ImagenMotas src={imagen1} alt="MotasUam" />
        <FormularioRegistro>
		<FormularioRegistroSecciones>
	<TitutuloSecciones>Datos del Permiso</TitutuloSecciones>
        ...
        Descripción<Input2  type="text" 
	        ...
	        <ContenedorBoton>
	                <Boton as="button" primario type="submit" onClick={() => navigate("/inicio-empleado")}>Registrar Permiso</Boton>
		</ContenedorBoton>
	</FormularioRegistro>
